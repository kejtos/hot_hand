...
reps = 1_000_000 # number of permutations
k = 3 # length of strings

directory = 'C:\\Users\\rejth\\my_drive\\OneDrive - Vysoká škola ekonomická v Praze\\Connection\\Plocha\\Doktorát\\Hot hand\\Data\\'
...
ax_H_s.set_xlabel('Entropy', fontsize=20)
ax_H_s.set_ylabel('Frequency', fontsize=20)

ax_H_s.text(H_s+1, 65000, r'Entropy of $\mathbf{X_{94}}$', fontsize=20, color='#599750', weight='bold')
ax_H_s.text(H_s+1, 25000, r'$\mathbf{\alpha = 0.05}$', fontsize=20, color='#FFCF9C')
ax_H_s.text(H_s-5, 15000, r'$\mathbf{\alpha = 0.01}$', fontsize=20, color='#FF7878')
